...
export function WhatsAppChat() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-white px-3 py-1.5 rounded-lg shadow-lg
        text-sm text-gray-700 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity
